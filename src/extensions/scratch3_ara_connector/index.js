...
class AraConnector {
     ...
     */
    _onSessionConnect () {
        //this._ble.read(BLEUUID.service, BLEUUID.onOffChar, true, callback);
        //this._ble.read(BLEUUID.service, BLEUUID.brightnessChar, true, callback)
